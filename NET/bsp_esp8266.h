...
#define      macESP8266_CH_PD_CLK                             RCC_APB2Periph_GPIOC   /* 定义ESP8266 CH_PD 引脚端口时钟 */
#define      macESP8266_CH_PD_PORT                            GPIOC                 /* 定义ESP8266 CH_PD 引脚端口*/
#define      macESP8266_CH_PD_PIN                             GPIO_Pin_15            /* 定义ESP8266 CH_PD 引脚*/

#define      macESP8266_RST_APBxClock_FUN                     RCC_APB2PeriphClockCmd/* 重定义开启ESP8266 RST 端口的时钟函数 */
#define      macESP8266_RST_CLK                               RCC_APB2Periph_GPIOC  /* 定义ESP8266 RST 引脚端口时钟 */
#define      macESP8266_RST_PORT                              GPIOC                 /* 定义ESP8266 RST 引脚端口*/
#define      macESP8266_RST_PIN                               GPIO_Pin_14            /* 定义ESP8266 RST 引脚*/

 

#define      macESP8266_USART_BAUD_RATE                       115200                /* 定义ESP8266的串口波特率为 115200*/      

#define      macESP8266_USARTx                                USART2                /* 定义ESP8266串口为串口3*/
#define      macESP8266_USART_APBxClock_FUN                   RCC_APB1PeriphClockCmd/* 重定义开启ESP8266 USART 的时钟函数 */
#define      macESP8266_USART_CLK                             RCC_APB1Periph_USART2 /* 重定义ESP8266 USART3 */
#define      macESP8266_USART_GPIO_APBxClock_FUN              RCC_APB2PeriphClockCmd /* 重定义开启ESP8266 USART GPIO 的时钟函数 */
#define      macESP8266_USART_GPIO_CLK                        RCC_APB2Periph_GPIOA   /* 定义ESP8266 串口 PIO 时钟*/    
#define      macESP8266_USART_TX_PORT                         GPIOA                  /* 定义ESP8266 串口 发送 GPIO 端口*/
#define      macESP8266_USART_TX_PIN                          GPIO_Pin_2            /* 定义ESP8266 串口 发送 GPIO 引脚*/
#define      macESP8266_USART_RX_PORT                         GPIOB                  /* 定义ESP8266 串口 接收 GPIO 端口*/
#define      macESP8266_USART_RX_PIN                          GPIO_Pin_3            /* 定义ESP8266 串口 接收 GPIO 引脚*/
#define      macESP8266_USART_IRQ                             USART2_IRQn             /* 重定义ESP8266 串口 中断*/
#define      macESP8266_USART_INT_FUN                         USART2_IRQHandler      /* 重定义ESP8266 串口 中断函数*/
