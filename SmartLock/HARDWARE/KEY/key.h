...
#define KEY5_GPIO_PIN		GPIO_Pin_5					/* 连接到SCL时钟线的GPIO */


#define KEY6_GPIO_CLK 	    RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define KEY6_GPIO_PORT    	GPIOB						/* GPIO端口 */
#define KEY6_GPIO_PIN		GPIO_Pin_6					/* 连接到SCL时钟线的GPIO */

#define KEY7_GPIO_CLK 	    RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define KEY7_GPIO_PORT    	GPIOB						/* GPIO端口 */
#define KEY7_GPIO_PIN		GPIO_Pin_7		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           			/* 连接到SCL时钟线的GPIO */

#define KEY8_GPIO_CLK 	    RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define KEY8_GPIO_PORT    	GPIOB						/* GPIO端口 */
#define KEY8_GPIO_PIN		GPIO_Pin_8				/* 连接到SCL时钟线的GPIO */
